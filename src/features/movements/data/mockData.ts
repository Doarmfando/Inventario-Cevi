// src/features/movements/data/mockData.ts - CORREGIDO CON mockProducts
...
// ✅ NUEVO: Export que estaba faltando - mockProducts para MovementForm
export const mockProducts = availableProducts.map(product => ({
  id: product.id,
  name: product.name,
  ...
  category: product.unit === 'kg' ? 'Alimentos' : 'Bebidas',
